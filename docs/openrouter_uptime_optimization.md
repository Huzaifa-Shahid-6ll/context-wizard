...
canonical-url: 'https://openrouter.ai/docs/features/uptime-optimization'
...
'og:image':
  type: url
  value: >-
    https://openrouter.ai/dynamic-og?title=Uptime%20Optimization&description=Maximize%20AI%20model%20availability
'og:image:width': 1200
'og:image:height': 630
...
import { UptimeChart } from '../../../imports/UptimeChart';
